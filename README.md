...
# 本地编译内容 ?
Flink-CDC 2.2.1 基于 Flink 1.13.5 构建。[flink cdc 支持1.14.4 版本记录](https://blog.csdn.net/weixin_40455124/article/details/122247436).
...
-- 去掉所有blink 依赖（1.14.2 已经去掉了blink jar，参考 https://issues.apache.org/jira/browse/FLINK-22879）

```

发布版本号  version=2.2.1_flink1.14.4
